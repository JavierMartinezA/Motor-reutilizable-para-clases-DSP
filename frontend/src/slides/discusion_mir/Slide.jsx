      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 1fr', gap: 28, alignItems: 'start' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          <div style={{ padding: '14px 18px', borderRadius: 12, background: '#fbf9f5', border: '1px solid #e8e3d8' }}>
            <div style={{ fontFamily: "'Inter', sans-serif", fontSize: 15, fontWeight: 800, color: INK }}>
              ¿Dos canciones distintas con el mismo fingerprint?
            </div>
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 14.5, color: INK_MUTED, lineHeight: 1.5, marginTop: 6 }}>
          ...
          <div style={{ padding: '14px 18px', borderRadius: 12, background: '#eefcf2', borderLeft: `4px solid ${GREEN}` }}>
            ...
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 14.5, color: INK, lineHeight: 1.5, marginTop: 6 }}>
            ...
            <div style={{ background: '#08111d', borderRadius: 8, padding: '12px 16px', marginTop: 8, color: '#9cf0b4', textAlign: 'center' }}>
              <MathFormula t="H_{\text{rel}} = \left(\textcolor{#4ade80}{\tfrac{f_2}{f_1}},\ \Delta t\right)\ \Rightarrow\ \text{invariante a transposición}" color="#cdeccd" size={1.15} display />
            </div>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          {QUESTIONS.map((q, i) => (
            <div key={i} style={{ display: 'grid', gridTemplateColumns: '28px 1fr', gap: 12, alignItems: 'baseline', padding: '12px 14px', borderRadius: 10, background: '#fbf9f5', border: '1px solid #e8e3d8' }}>
              ...
              <span style={{ fontFamily: "'Inter', sans-serif", fontSize: 15, color: INK, lineHeight: 1.45 }}>{q}</span>
            </div>
          ))}
          ...
          <div style={{ marginTop: 6, padding: '14px 18px', borderRadius: 12, background: '#f3eefc', borderLeft: `4px solid ${VIOLET}` }}>
            ...
            <p style={{ fontFamily: "'Newsreader', serif", fontSize: 17.5, fontStyle: 'italic', color: INK, lineHeight: 1.5, marginTop: 6 }}>
          ...
          <div style={{ fontFamily: "'Inter', sans-serif", fontSize: 13.5, color: INK_FAINT, textAlign: 'center' }}>
